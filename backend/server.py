...
try:
    ...
    from routes import auth_router, user_router, files_router, folders_router, payments_router, epk_router, notifications_router, ai_router
    # region agent log
    ...
    from backend.routes import auth_router, user_router, files_router, folders_router, payments_router, epk_router, notifications_router, ai_router
    # region agent log
