...
def serialize_user(user: dict) -> dict:
    return {
        ...
        "preferred_channel": user.get("preferred_channel", "email"),
...
def get_plan_credits(plan: str) -> int:
    ...
    if plan == "creator":
        return settings.get("creator_credits", 600)
    elif plan == "pro":
        return settings.get("pro_credits", 2500)
    return settings.get("free_credits", 150)
