...
function AppsPage({ portal = 'music', subdomainPage = null, onOpenAppModal, onToast }) {
  ...
  return (
    <>
      {/* Page Header */}
      <PageHeader pageKey="apps" portal={portal} breadcrumb={pageCopy.breadcrumb} title={pageCopy.title} subtitle={pageCopy.subtitle} />
          ...
          <div className="acta">
            ...
            <p>
              {portal === 'music' 
                ...
                : 'Brand kits, press kits and sync pitches at tunemavens.com.'}
            </p>
            <button 
              className="hbp"
              onClick={() => onToast('Portal switch coming soon!', '', '🔄')}
            >
              {portal === 'music' ? 'Go to intermaven.io' : 'Go to tunemavens.com'} →
            </button>
          </div>
