...
function EPKBuilder({ user, addToast, updateUser }) {
  ...
  const [form, setForm] = useState({
    ...
    is_published: false,
    hosting: { intermaven: true, tunemavens: false, custom_domain: '' },
  });
        ...
        <div className="epk-tab-content">
          <Section title="Hosting Options" icon={Globe}>
            ...
            {[
              ...
              { key: 'tunemavens', label: 'tunemavens.com', desc: `tunemavens.com/artist/${form.username || 'yourname'}` },
          ...
          {epk?.id && form.is_published && (
            <Section title="Share Your EPK" icon={Share2} collapsible defaultOpen={false}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {['intermaven.io/artist/', 'tunemavens.com/artist/'].map(base => (
