...
function popDash() {
  ...
  if (uw) uw.innerHTML = S.plan === 'free'
    ? '<div class="upg-ban"><div style="font-size:22px">&#128293;</div>' +
      ...
      '<div style="font-size:11px;color:var(--mu)">Upgrade to Creator (' + (window.IntermavenRegion && window.IntermavenRegion.isWesternRegion() ? '$5' : 'KES 500') + ') for 600 credits, faster AI, and Social AI with 6 accounts.</div></div>' +
