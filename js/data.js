...
var PORTALS = {
  music:{
    ...
    ptabout:'About TuneMavens',
    ab2:'This portal \u2014 tunemavens.com \u2014 is purpose-built for artists and creatives.',
  ...
  business:{
    ...
    ctah:'Need music or creative tools?', ctap:'Brand kits, press kits and sync pitches at tunemavens.com.', ctabt:'Go to tunemavens.com', ctabf:"swPortal('music')",
    ...
    alth:'&#127925; TuneMavens', altp:'AI tools for artists \u2014 brand kits, press kits, sync pitches, and more.',
    alttags:['Brand Kit AI','Music Bio AI','Sync Pitch AI','EPK Builder'],
    altbtn:'Go to tunemavens.com', altbf:"swPortal('music')",
    apps:null
  }
};
...
var LEGAL_CONTENT = {
  ...
  sitemap:{ title:'Sitemap', body:'tunemavens.com \u2014 Home, AI Tools, App Marketplace, Pricing, About\n\nintermaven.io \u2014 Home, AI Tools, App Marketplace, Pricing, About' },
